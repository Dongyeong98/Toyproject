...
import { TOUCH_NUMBER_SCROPE_KEY } from "./constants/localStorage.js";
...
const handleSuccessGame = () => {
    ...
    const currentSpendTime = localStorage.getItem(TOUCH_NUMBER_SCROPE_KEY);
    if (!currentSpendTime || currentSpendTime > nowSpendTime ) {
        localStorage.setItem(TOUCH_NUMBER_SCROPE_KEY,nowSpendTime);
    }
    setTimer(0);
}
