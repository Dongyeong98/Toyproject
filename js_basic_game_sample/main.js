import { ARROW_SPEED_SCORE_KEY, MOUSE_CONTROL_SCROPE_KEY, TOUCH_NUMBER_SCROPE_KEY } from "./constants/localStorage.js";
...
const localStorageketMap = {
    1 : MOUSE_CONTROL_SCROPE_KEY,
    2 : TOUCH_NUMBER_SCROPE_KEY,
...
const getGameCard = ({
    ...
    const result = localStorage.getItem(localStorageketMap[id]);
